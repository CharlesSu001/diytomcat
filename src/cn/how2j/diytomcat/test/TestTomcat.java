...
public class TestTomcat {
    ...
    public void testJavawebHello(){
        ...
        containAssert(html,"Hello DIY Tomcat from HelloServlet2.0@javaweb");
    }
    ...
    public void testgetParam(){
        ...
        params.put("name","yasoo");
        String html=MiniBrowser.getContentString(url,params,true);
        Assert.assertEquals(html,"get name:yasoo");
    }
    ...
    public void testpostParam(){
        ...
        String url=StrUtil.format("http://{}:{}{}",ip,port,uri);
        Map<String,Object> params=new HashMap<>();
        params.put("name","teemo");
        String html=MiniBrowser.getContentString(url,params,false);
        Assert.assertEquals(html,"post name:teemo");
    }

    @Test
    public void testheader(){
        String html=getContentString("/javaweb/header");
        Assert.assertEquals(html,"how2j mini browser / java 1.8");
    }
